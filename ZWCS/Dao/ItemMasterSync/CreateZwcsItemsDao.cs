...
{
    class CreateZwcsItemsDao : AbstractDataAccessObject
    {
        /// <summary>
        /// Initialize logger
        /// </summary>
        private static readonly CommonLogger logger = CommonLogger.GetInstance(typeof(CreateZwcsItemsDao));
        ...
        public override ValueObject Execute(TransactionContext trxContext, ValueObject arg)
        {
            ...
            sqlQuery.Append("INSERT INTO m_item ");
            sqlQuery.Append("( ");
